        ...
        <>
            ...
            <div style={{
                ...
                background: demoRole === 'hr'
                    ...
                    : 'radial-gradient(circle at 50% 50%, rgba(99, 102, 241, 0.08) 0%, transparent 100%)'
            }}>
                <motion.div
                    className="glass-card"
                    style={{ padding: '48px', width: '100%', maxWidth: '450px', borderColor: demoRole === 'hr' ? 'rgba(16, 185, 129, 0.3)' : 'rgba(99, 102, 241, 0.3)' }}
                ...
                >
                    <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                        <div style={{
                            width: '64px',
                            height: '64px',
                            background: demoRole === 'hr' ? 'rgba(16, 185, 129, 0.1)' : 'rgba(99, 102, 241, 0.1)',
                            borderRadius: '20px',
                            display: 'flex',
                            justifyContent: 'center',
                            alignItems: 'center',
